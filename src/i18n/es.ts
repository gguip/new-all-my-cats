...
const es: typeof en = {
  brand: 'Catastrophe',
  nav: { theCats: 'Los Gatos', about: 'Sobre', support: 'Apoya', sayHi: 'Saluda', family: 'Familia' },
  a11y: {
    home: 'Inicio Catastrophe',
    menu: 'Menú',
    close: 'Cerrar',
    facebook: 'Facebook',
    instagram: 'Instagram',
  ...
  welcome: {
    ...
    features: [
      ...
      { label: 'Zoomies Infinitos', tag: 'gato en pleno zoomie' },
    ],
  },
  attrs: {
    fome: 'Hambriento',
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: '¿Se llevan bien todos?',
        a: '¡Casi todos! Hay alianzas, rivalidades y algún que otro campeonato de lucha libre a las 3 de la madrugada — pero al final del día se amontonan juntos como una gran manta peluda.',
      },
      {
      ...
      {
        q: '¿Cuánto duermen?',
        a: '¿En total? Unas 280 horas al día. Mira las barras de Dormilón — algunos son básicamente pilas peludas permanentemente en standby.',
      },
      {
        q: '¿Puedo ver más de ellos?',
        a: 'Para eso existe literalmente toda esta página. Sube y conoce a la pandilla, una personalidadcita caótica a la vez.',
      },
    ],
  },
  contact: {
  ...
  family: {
    ...
    subtitle: 'Cómo fue llegando la pandilla',
